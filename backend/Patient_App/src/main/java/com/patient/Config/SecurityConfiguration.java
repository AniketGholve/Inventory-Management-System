...
public class SecurityConfiguration {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeHttpRequests()
				...
				.requestMatchers(new AntPathRequestMatcher("/login"),new AntPathRequestMatcher("/api/SuccessOrders/1"), new AntPathRequestMatcher("/api/ErrorOrders/1"), new AntPathRequestMatcher("/api/addUser"), new AntPathRequestMatcher("/api/editUser/"))
